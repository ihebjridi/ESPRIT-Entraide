 ...
 * @author Seif Bejaoui
 */
public class Admin_LO_PublishController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ArrayList arrayList = (ArrayList) LOservice.admin_selectAll_publish();
            ...
            if (!checkTitle.isSelected() && !checkDesc.isSelected() && !checkUser.isSelected()) {
                ...
                if (newValue.equals("")) {
                    ...
                    if (checkTitle.isSelected()) {
                        ArrayList newarrayList = (ArrayList) LOservice.searchAdminByTitle(newValue, "publish");
                        ...
                        ArrayList newarrayList = (ArrayList) LOservice.searchAdminByDescription(newValue, "publish");
                        ObservableList newobservableList = FXCollections.observableArrayList(newarrayList);
                        table.setItems(newobservableList);
                        user.setCellValueFactory(new PropertyValueFactory<>("username"));
                        title.setCellValueFactory(new PropertyValueFactory<>("title"));
                        ...
                        ArrayList newarrayList = (ArrayList) LOservice.searchAdminByUser(newValue, "publish");
                        ObservableList newobservableList = FXCollections.observableArrayList(newarrayList);
                        table.setItems(newobservableList);
                        user.setCellValueFactory(new PropertyValueFactory<>("username"));
                        title.setCellValueFactory(new PropertyValueFactory<>("title"));
