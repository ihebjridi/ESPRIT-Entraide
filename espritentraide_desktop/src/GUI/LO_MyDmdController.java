 ...
 * @author Seif Bejaoui
 */
public class LO_MyDmdController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ArrayList arrayList = (ArrayList) LOservice.selectMyDemande(s.getId());
        ...
        action2.setCellValueFactory(new PropertyValueFactory<>("btn5"));
            ...
            if (!checkTitle.isSelected() && !checkDesc.isSelected()) {
                ...
                if (newValue.equals("")) {
                    ...
                    if (checkTitle.isSelected()) {
                        ArrayList newarrayList = (ArrayList) LOservice.searchMineByTitle(newValue,"demande");
                        ...
                        ArrayList newarrayList = (ArrayList) LOservice.searchMineByDescription(newValue,"demande");
                        ObservableList newobservableList = FXCollections.observableArrayList(newarrayList);
                        table.setItems(newobservableList);
                        user.setCellValueFactory(new PropertyValueFactory<>("username"));
                        title.setCellValueFactory(new PropertyValueFactory<>("title"));
