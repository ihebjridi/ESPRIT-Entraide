 ...
 * @author Seif Bejaoui
 */
public class Admin_LO_AttenteController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ArrayList arrayList = (ArrayList) LOservice.admin_selectAll_Attente();
            ...
            if (!checkTitle.isSelected() && !checkDesc.isSelected() && !checkUser.isSelected()) {
                ...
                if (newValue.equals("")) {
                    ...
                    if (checkTitle.isSelected()) {
                        ArrayList newarrayList = (ArrayList) LOservice.searchAdminByTitle(newValue, "attente");
                        ...
                        ArrayList newarrayList = (ArrayList) LOservice.searchAdminByDescription(newValue, "attente");
                        ObservableList newobservableList = FXCollections.observableArrayList(newarrayList);
                        table.setItems(newobservableList);
                        user.setCellValueFactory(new PropertyValueFactory<>("username"));
                        title.setCellValueFactory(new PropertyValueFactory<>("title"));
                        ...
                        ArrayList newarrayList = (ArrayList) LOservice.searchAdminByUser(newValue, "attente");
                        ObservableList newobservableList = FXCollections.observableArrayList(newarrayList);
                        table.setItems(newobservableList);
                        user.setCellValueFactory(new PropertyValueFactory<>("username"));
                        title.setCellValueFactory(new PropertyValueFactory<>("title"));
