 ...
 * @author Seif Bejaoui
 */
public class LO_PerduController implements Initializable {
...
//        System.out.println("seission: "+ s.getId());
            ...
            if (!checkTitle.isSelected() && !checkDesc.isSelected() && !checkUser.isSelected()) {
                ...
                if (newValue.equals("")) {
                    ...
                    if (checkTitle.isSelected()) {
                        ArrayList newarrayList = (ArrayList) LOservice.searchByTitle(newValue,"annonce");
                        ...
                        ArrayList newarrayList = (ArrayList) LOservice.searchByDescription(newValue,"annonce");
                        ObservableList newobservableList = FXCollections.observableArrayList(newarrayList);
                        table.setItems(newobservableList);
                        user.setCellValueFactory(new PropertyValueFactory<>("username"));
                        title.setCellValueFactory(new PropertyValueFactory<>("title"));
                        ...
                        ArrayList newarrayList = (ArrayList) LOservice.searchByUser(newValue,"annonce");
                        ObservableList newobservableList = FXCollections.observableArrayList(newarrayList);
                        table.setItems(newobservableList);
                        user.setCellValueFactory(new PropertyValueFactory<>("username"));
                        title.setCellValueFactory(new PropertyValueFactory<>("title"));
