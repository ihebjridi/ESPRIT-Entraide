 ...
 * @author HP
 */
public class Cov_MyDmdController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ArrayList arrayList = (ArrayList) Cov.selectMyDemande(s.getId());
    ...
    private void SupprimerDemande(ActionEvent event) {
        ...
        alert.showAndWait().ifPresent(response -> {
            if (response == ButtonType.OK) {
                ...
                Parent root;
                try {
                    root = FXMLLoader.load(getClass().getResource("/GUI_COV/Cov_MyDmd.fxml"));
    ...
    private void ModiferDemande(ActionEvent event) {
        try {
            ...
            FXMLLoader loader;
            loader = new FXMLLoader(getClass().getResource("/GUI_COV/Cov_ModifierDemande.fxml"));
            Cov_ModifierDemandeController controller = loader.getController();
            ...
            Logger.getLogger(Cov_MyDmdController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    @FXML
     private void Dmd(MouseEvent event) {
        int id = table.getSelectionModel().getSelectedItem().getId();
