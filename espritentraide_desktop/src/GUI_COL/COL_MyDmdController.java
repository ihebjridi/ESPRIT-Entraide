 ...
 * @author ASUS PC
 */
public class COL_MyDmdController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ArrayList arrayList = (ArrayList) FS.selectMyDemande(s.getId());
    ...
    private void click(MouseEvent event) {
        ...
        alert.setTitle("Gestio de demandes");
        ...
        if (result.get() == Supprimer) {
            ...
            alert1.showAndWait().ifPresent(response -> {
                if (response == ButtonType.OK) {
                    ...
                    Parent root;
                    try {
                        root = FXMLLoader.load(getClass().getResource("/GUI_COL/COL_MyDmd.fxml"));
                        Scene scene = new Scene(root);
                        Stage x = (Stage) this.table.getScene().getWindow();
                        x.setScene(scene);
                        x.show();
                    } catch (IOException ex) {
                        Logger.getLogger(COL_MyDmdController.class.getName()).log(Level.SEVERE, null, ex);
                    }
            ...
            try {
                ...
                FXMLLoader loader;
                loader = new FXMLLoader(getClass().getResource("/GUI_COL/COL_UpdateMyDmd.fxml"));
                COL_UpdateMyDmdController controller = loader.getController();
