 ...
 * @author Seif Bejaoui
 */
public class LO_AddAds {

    Form form;

    public LO_AddAds() {

        form = new Form("Ajouter une annonce",BoxLayout.y());
        ...
        ajouter.addActionListener(m -> {
            ServiceLO.AddAds(txttitle.getText(), txtdesc.getText(),"annonce");
            Dialog.show("Ajout effectué", "Votre annonce a été ajouté avec succees", "ok", null);
            LO_MyAds myads = new LO_MyAds();
            myads.getForm().show();
        });
