 ...
 * @author Seif Bejaoui
 */
public class LO_result {

    Form form, f2;
    private ArrayList<LostObject> list;
    Resources theme = UIManager.initFirstTheme("/theme");

    public LO_result(String mot, Boolean annonce, Boolean demande, Date p){
        form = new Form("Resultat", BoxLayout.y());
        ...
        list = ServiceLO.search(mot,annonce,demande,p);
